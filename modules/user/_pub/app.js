    ...
    my.modules.user = new function()
    {
        ...
        this.search = new function()
        {
            ...
            this.init = function(data)
            {
                ...
                var theaders = ['image', 'fullname', 'category', 'email', 'in_school', 'comments', 'deleted'];
            ...
            this.set_all = function(e)
            {
                ...
                var theaders = ['image', 'fullname', 'category', 'email', 'barcode', 'in_school', 'comments', 'deleted'];
                var query_string = '';
